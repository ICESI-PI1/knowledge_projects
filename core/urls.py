...
urlpatterns = [
    ...
    path('ehome/beneficiaries/',views.Employee_beneficiaries.as_view(),name='ebeneficiaries'),
    path('ehome/beneficiaries/<beneficiary_id>',views.Edit_beneficiaries.as_view(),name='e_edit_beneficiaries'),
